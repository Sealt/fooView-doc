...
1）网址栏输入时默认自动全部选中 2）修复视频预览切换时无法用FV播放器打开视频的问题 3）修复悬浮窗切换横竖屏时左侧导航宽度变小的问题 4）修复视频窗口默认值情况下记不住窗口大小的问题 5）处理兼容MIUI开发版系统的Bug 6）处理8.0以下系统上部分软件粘贴会包含Hint的问题 7）改进部分UI
